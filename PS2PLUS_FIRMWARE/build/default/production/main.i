...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic16f18876.h"
...
if(analogMode == 0) response[0] = 0x82;
if(analogMode == 1) response[0] = 0xCE;
if(analogMode > 1) response[0] = 0x9E;
}
